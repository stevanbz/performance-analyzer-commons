...
public class NetworkMetricsCalculator {
    ...
    public static NetInterfaceSummary calculateInNetworkMetrics(
        ...
        long nin =
                curipv4.get(Ipv4Observer.Ipv4Keys.IN_RECEIVES.getLabel())
                        - oldipv4.get(Ipv4Observer.Ipv4Keys.IN_RECEIVES.getLabel());
        long delivin =
                curipv4.get(Ipv4Observer.Ipv4Keys.IN_DELIVERS.getLabel())
                        - oldipv4.get(Ipv4Observer.Ipv4Keys.IN_DELIVERS.getLabel());
        long nin6 =
                curipv6.get(Ipv6Observer.Ipv6Keys.IN_RECEIVES.getLabel())
                        - oldpv6.get(Ipv6Observer.Ipv6Keys.IN_RECEIVES.getLabel());
        long delivin6 =
                curipv6.get(Ipv6Observer.Ipv6Keys.IN_DELIVERS.getLabel())
        ...
        double inbps =
                8
                        * 1.0e3
                        * (curphy.get(
                                        DeviceNetworkStatsObserver.NetworkStatKeys.IN_BYTES
                                                .getLabel())
                                - oldphy.get(
                                        DeviceNetworkStatsObserver.NetworkStatKeys.IN_BYTES
                                                .getLabel()))
    ...
    public static NetInterfaceSummary calculateOutNetworkMetrics(
        ...
        long dropout =
                curipv4.get(Ipv4Observer.Ipv4Keys.OUT_DISCARDS.getLabel())
        ...
        long nout6 =
                curipv6.get(Ipv6Observer.Ipv6Keys.OUT_REQUESTS.getLabel())
                        - oldpv6.get(Ipv6Observer.Ipv6Keys.OUT_REQUESTS.getLabel());
        long dropout6 =
                curipv6.get(Ipv6Observer.Ipv6Keys.OUT_DISCARDS.getLabel())
        ...
        double outbps =
                8
                        * 1.0e3
                        * (curphy.get(
                                        DeviceNetworkStatsObserver.NetworkStatKeys.OUT_BYTES
                                                .getLabel())
                                - oldphy.get(
                                        DeviceNetworkStatsObserver.NetworkStatKeys.OUT_BYTES
                                                .getLabel()))
