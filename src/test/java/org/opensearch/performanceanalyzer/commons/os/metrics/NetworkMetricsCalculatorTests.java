...
public class NetworkMetricsCalculatorTests {
    ...
    public void testCalculateInNetworkMetrics() {
        ...
        Map<String, Long> curphy =
                Collections.singletonMap(
                        DeviceNetworkStatsObserver.NetworkStatKeys.IN_BYTES.getLabel(), endNum);
        Map<String, Long> oldphy =
                Collections.singletonMap(
                        DeviceNetworkStatsObserver.NetworkStatKeys.IN_BYTES.getLabel(), startNum);
        NetInterfaceSummary result =
    ...
    public void testCalculateOutNetworkMetrics() {
        ...
        Map<String, Long> curphy =
                Collections.singletonMap(
                        DeviceNetworkStatsObserver.NetworkStatKeys.OUT_BYTES.getLabel(), endNum);
        Map<String, Long> oldphy =
                Collections.singletonMap(
                        DeviceNetworkStatsObserver.NetworkStatKeys.OUT_BYTES.getLabel(), startNum);
        NetInterfaceSummary result =
